...
extern "C" {
    ...
    */
    ...
    extern uint32_t bcm2835_peri_read_Prototype(volatile uint32_t* paddr);
    ...
    */
	...
	/*! Just reads from the Slave devices
	*   
	*/
	extern uint8_t bcm2835_spi_read_prototype(void);
    ...
    */
    ...
    /*!	Same thing as above function except that it does not automatically change the Slave Select outputs
        Using this means that the user MUST change the Slave Select logic manually
    */
    extern uint8_t bcm2835_spi_transfer_prototype(uint8_t value);
    
    
    void bcm2835_spi_slave_clear_fifo_prototype(void);
    
    /*! 
     * Manual Slave Select Opening or Chip Select opening 
    */
    void bcm2835_spi_Slave_Open_prototype(void);

    /*! 
     * Manual Slave Select Closing or Chip Select closing 
    */
    ...
    */
	...
	// Writes a single byte to selected SPI slave
